...
const Cart: React.FC = () => {
  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-screen bg-gray-50 py-8" style={backgroundImageStyle}>
        <div className="backdrop-blur-sm bg-white/70 rounded-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
